...
uint32_t GetRunTimeTimer(void)
{
  return (configRUNTIME_TIMER->CNT);
}
#ifdef __cplusplus
}
#endif
...
/* Enable TIM1clock */
  configRUNTIME_TIMER_CLK_ENABLE();      

   /* Initialize TIM */
  htim.Instance = configRUNTIME_TIMER;
...
void RunTime_c::Tick( void)
{
  ...
  vTaskSuspendAll();
  totalRuntime = configRUNTIME_TIMER->CNT;
